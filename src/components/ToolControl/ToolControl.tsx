  ...
  return (
    <div style={{ display: "flex", height: "100%", minHeight: "400px" }}>
      ...
      >
        ...
        <div className="absolute left-2 bottom-[5rem] flex items-center justify-center">
          <button
            className="text-center flex font-bold text-pretty justify-center items-center"
